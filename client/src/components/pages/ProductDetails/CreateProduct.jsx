...
export default function CreateProduct() {
  ...
  const handleSubmit =async(e)=>{
    ...
    if (isEmpty) {
      return setError('Please fill out everything');
    }
    ...
    <form id={styles["product-form"]} onSubmit={handleSubmit}>
      <div id={styles["form-details"]}>
        ...
        <div className={styles["offer"]}>
          <span> Offer: </span> <input type="checkbox" id="offer" onChange={handleChange} />
        </div>
      ...
      <div id={styles["form-details"]}>
        ...
        <button disabled={loading || uploading} className="normal" type="submit">{loading ? "Adding..." : "Add a Product"}</button>
